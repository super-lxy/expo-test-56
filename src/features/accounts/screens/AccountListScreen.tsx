...
const styles = StyleSheet.create({
  ...
  addButton: { backgroundColor: '#DBEAFE', borderRadius: 13, paddingHorizontal: 13, paddingVertical: 9 },
  addText: { color: '#1D4ED8', fontWeight: '800' },
  totalCard: { backgroundColor: '#172554', borderRadius: 22, padding: Spacing.four, gap: Spacing.two },
  totalLabel: { color: '#BFDBFE', fontWeight: '700' },
  totalAmount: { color: '#FFFFFF', fontSize: 34, fontWeight: '900' },
  totalHint: { color: '#BFDBFE' },
  list: { gap: Spacing.two },
  accountCard: { flexDirection: 'row', alignItems: 'center', gap: Spacing.three, padding: Spacing.three, borderRadius: 18, backgroundColor: '#F1F5F9' },
  accountIcon: { width: 46, height: 46, borderRadius: 15, backgroundColor: '#DBEAFE', alignItems: 'center', justifyContent: 'center' },
  accountIconText: { fontSize: 22 },
  accountInfo: { flex: 1, gap: 2 },
  accountName: { fontWeight: '800' },
  accountBalance: { fontWeight: '900', fontSize: 16 },
});
