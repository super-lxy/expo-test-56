...
const styles = StyleSheet.create({
  ...
  label: { ...Type.subhead, fontWeight: FontWeight.semibold, marginTop: 8 },
  input: { borderWidth: 1, borderColor: '#DDE3E8', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 13, ...Type.body, color: '#17212B', backgroundColor: '#FFFFFF' },
