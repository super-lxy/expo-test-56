...
const styles = StyleSheet.create({
  ...
  addButton: { backgroundColor: '#DBEAFE', borderRadius: 13, paddingHorizontal: 12, paddingVertical: 9 },
  addText: { color: '#1D4ED8', fontWeight: '800' },
  switch: { flexDirection: 'row', backgroundColor: '#E5E7EB', padding: 4, borderRadius: 15 },
  switchButton: { flex: 1, alignItems: 'center', paddingVertical: 11, borderRadius: 12 },
  expenseSelected: { backgroundColor: '#FEE2E2' },
  incomeSelected: { backgroundColor: '#DCFCE7' },
  tree: { gap: Spacing.two },
  parentRow: { borderRadius: 17, backgroundColor: '#F1F5F9', padding: Spacing.three, gap: Spacing.two },
  parentHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  parentName: { fontSize: 17, fontWeight: '800' },
  addChild: { color: '#2563EB', fontWeight: '700' },
