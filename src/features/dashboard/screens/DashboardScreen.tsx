...
const styles = StyleSheet.create({
  ...
  brandIcon: { width: 32, height: 32, borderRadius: 10, backgroundColor: '#F7F0FF', alignItems: 'center', justifyContent: 'center' },
  brandIconText: { ...Glyph.sm, fontWeight: FontWeight.bold, color: '#8B5CF6' },
